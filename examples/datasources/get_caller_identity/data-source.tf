...
data "awsutils_get_caller_identity" "default" {
}

output "account_id" {
  value = data.awsutils_get_caller_identity.default.account_id
}

output "caller_arn" {
  value = data.awsutils_get_caller_identity.default.arn
}
